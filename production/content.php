...
<div class="right_col" role="main" style="max-height: 1000px">
  <div class="">
    <div class="row top_tiles">
      <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12"> <a href="index.php?data=Present">
      ...
      <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12"> <a href="index.php?data=Absent">
        <div class="tile-stats">
      ...
      <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12"> <a href="index.php?data=checkOut">
        <div class="tile-stats">
    ...
    <div class="row">
      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          ...
          <div class="x_content">
            <button type="button" class="btn btn-info btn-sm" style="float:right;" data-toggle="modal" data-target="#SearchByDate">Search by Date Range</button>
            <div id="ReplaceData">
...
color: white;" <?php } ?>>
                    ...
                    <td><?php if(isset($records[$i]['check_date'])){ echo $records[$i]['in']; } ?>
                      ...
                      <!--
                                                <input type="text" class="form-control" onclick="return enable_box('<?php echo "in_time_".$id; ?>');" onblur="return update_field('in_time',<?php echo $id; ?>);"
                                                               name="in_time_<?php echo $id; ?>" value="<?= $data['in'] ?>" readonly="readonly" />--></td>
                    <td><?= (isset($records[$i]['out']) && !empty($records[$i]['out'])) ? $records[$i]['out'] : "Not Checked Out"; ?>
                      ...
                      <!-- <input type="text" class="form-control" onclick="return enable_box('<?php echo "out_time_".$id; ?>');" onblur="return update_field('out_time',<?php echo $id; ?>);"
                                                               name="out_time_<?php echo $id; ?>" value="<?= (isset($records[$i]['out']) && !empty($records[$i]['out'])) ?$records[$i]['out'] : "Not Checked Out"; ?>" readonly="readonly" />--></td>
...
<div id="SearchByDate" class="modal fade" role="dialog">
  <div class="modal-dialog"> 
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="demo-form2" data-parsley-validate="" class="form-horizontal form-label-left" novalidate="" action="<?php echo $_SERVER["PHP_SELF"];?>" method="post">
          <div class="form-group">
